package com.tf.backend.core.application.domain.auth.impl;
...
import com.tf.backend.core.application.security.JwtProvider;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public Authentication buildAuthenticationFor(String token) throws TokenAuthenticationException {
        try {
            return buildAuthentication(jwtProvider.getUserId(token), token, PermType.API);
     ...
     */
    @Override
    public TokenResponseDTO refreshToken(String refreshToken) throws TokenAuthenticationException {
        try {
            // 解析并验证旧 RT 的签名与有效期
